...
const meta = {
    ...
    argTypes: {
        ...
        nationsAfter: {
            control: 'text',
            description:
                "HTML string to insert after the select's underlying HTML element",
        },
        diocesesAfter: {
            control: 'text',
            description:
    ...
    render: (args, { loaded: { apiClient } }) => {
        ...
        const calendarSelectNations = new CalendarSelect(args.locale).filter(
            CalendarSelectFilter.NATIONAL_CALENDARS,
        );
        const calendarSelectDioceses = new CalendarSelect(args.locale).filter(
        ...
        if (
            args.labelClass ||
            args.nationsLabelText ||
            args.diocesesLabelText
        ) {
            const nationsLabel = {};
            const diocesesLabel = {};
            if (args.labelClass) {
    ...
    parameters: {
        actions: {
            handles: [
                'change',
                'change #calendarSelectFilteredContainer select',
            ],
        },
    },
    args: {
...
export const EnglishBootstrap = {
    args: {
        ...
        diocesesLabelText: 'Select a diocese',
        nationsAfter:
            '<small class="text-muted"><i>Selections made here will determine the available diocese options</i></small>',
        diocesesAfter:
            '<small class="text-muted"><i>Available diocese options depend on the nation selection</i></small>',
    },
};
...
export const ItalianBootstrap = {
    args: {
        ...
        nationsAfter:
            '<small class="text-muted"><i>Selezioni fatte qui determineranno le opzioni di diocesi disponibili</i></small>',
        diocesesAfter:
            '<small class="text-muted"><i>Le opzioni di diocesi disponibili dipendono dalla selezione della nazione</i></small>',
    },
};
...
export const SpanishBootstrap = {
    args: {
        ...
        nationsAfter:
            '<small class="text-muted"><i>Las opciones seleccionadas aquí determinarán las opciones de diocesis disponibles</i></small>',
        diocesesAfter:
            '<small class="text-muted"><i>Las opciones de diocesis disponibles dependen de la selección de la nación</i></small>',
    },
};
...
export const FrenchBootstrap = {
    args: {
        ...
        nationsAfter:
            '<small class="text-muted"><i>Les sélections faites ici détermineront les options de diocese disponibles</i></small>',
        diocesesAfter:
            '<small class="text-muted"><i>Les options de diocese disponibles dépendent de la sélection de la nation</i></small>',
    },
};
...
export const GermanBootstrap = {
    args: {
        ...
        nationsAfter:
            '<small class="text-muted"><i>Die ausgewählten Optionen hier bestimmen die verfügbaren Diocese-Optionen</i></small>',
        diocesesAfter:
            '<small class="text-muted"><i>Die verfügbaren Diocese-Optionen sind abhängig von der ausgewählten Nation</i></small>',
    },
};
