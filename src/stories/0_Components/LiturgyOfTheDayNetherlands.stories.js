 ...
 * and requesting the National Calendar for the Netherlands from the ApiClient instance.
 */
const meta = {
  title: 'Components/LiturgyOfTheDay/National Calendar/Netherlands',
  tags: ['autodocs'],
  argTypes: {
    locale: {
      control: 'text',
  ...
  render: (args, { loaded: { apiClient } }) => {
    ...
    if (false === apiClient || false === apiClient instanceof ApiClient) {
        ...
        if (false === refetched) {
            ...
            apiClient.fetchNationalCalendar('NL');
        }
