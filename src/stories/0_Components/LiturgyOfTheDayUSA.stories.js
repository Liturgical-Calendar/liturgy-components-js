 ...
 * and requesting the National Calendar for the USA from the ApiClient instance.
 */
const meta = {
  title: 'Components/LiturgyOfTheDay/National Calendar/USA',
  tags: [ 'autodocs' ],
  argTypes: {
    locale: {
      control: 'text',
  ...
  render: ( args, { loaded: { apiClient } } ) => {
    ...
    if ( false === apiClient || false === apiClient instanceof ApiClient ) {
      ...
      if ( false === refetched ) {
        ...
        apiClient.fetchNationalCalendar( 'US' );
      }
